...
namespace Project_college.Migrations
{
    ...
    [Migration("20190503000739_migrationSalle12")]
    partial class migrationSalle12
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project_college.Models.Salle", b =>
                {
                    ...
                    b.HasIndex("SalleTypeId");

                    b.ToTable("Salles");
                });

            modelBuilder.Entity("Project_college.Models.SalleType", b =>
                {
                    b.Property<int>("SalleTypeId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Project_college.Models.Salle", b =>
                {
                    b.HasOne("Project_college.Models.SalleType", "SalleType")
                        .WithMany("Salles")
                        .HasForeignKey("SalleTypeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
